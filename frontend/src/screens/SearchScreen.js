...
/*
sm={6} means that on small screens, the <Col> component will take up 6 columns out of the 12 available columns.
lg={4} means that on large screens, the <Col> component will take up 4 columns out of the 12 available columns.
*/

/*
m: Stands for margin.
x: Stands for the x-axis, which refers to the horizontal axis.
1: Represents the margin size. In Bootstrap, spacing utilities like mx-1 use a scale where the numbers indicate different sizes. In this case, 1 is a small margin size.
So, mx-1 sets a small margin on both the left and right sides of the element. It's a shorthand way of writing both ml-1 (left margin of size 1) and mr-1 (right margin of size 1).
mx-2 large
*/
...
export default function SearchScreen() {
    ...
    console.log(category , query , price , rating , order , page)
